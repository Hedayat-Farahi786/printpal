      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              We at PrintPal believe that a phone case doesn't only need to look
        ...
        <div className="space-y-6 border-t border-zinc-200 pt-10 text-sm">
            <div className="flex justify-between">
                <div className="font-medium text-zinc-900">Subtotal</div>
                <div className="text-zinc-700">{formatPrice(amount)}</div>
            </div>
            <div className="flex justify-between">
                <div className="font-medium text-zinc-900">Shipping</div>
                <div className="text-zinc-700">{formatPrice(0)}</div>
            </div>
            <div className="flex justify-between">
                <div className="font-medium text-zinc-900">Total</div>
                <div className="text-zinc-700">{formatPrice(amount)}</div>
            </div>
        </div>
      </div>
